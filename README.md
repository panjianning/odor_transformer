...
Epoch 300/300
--------------------------------------------------
  Batch 0/125, Loss: 0.3941
  Batch 50/125, Loss: 0.4220
  Batch 100/125, Loss: 0.4653
tensor(1.)
tensor(1.0000)
训练结果:
  Train Loss: 0.4587
  ...
  Train Acc: 0.8978
  Val Acc: 0.8936
  Train F1-Macro: 0.2441
  Val F1-Macro: 0.2181
  Train AUC-Macro: 0.8544
  Val AUC-Macro: 0.8401
  Time: 35.06s
早停触发，停止训练
...
测试结果:
  ...
  auc_macro: 0.8444
  loss: 0.4787
{'accuracy': 0.8910719752311707, 'f1_macro': 0.20882739715676873, 'auc_macro': 0.8444328824322224, 'loss': 0.47865535132586956}
```